...
/* Button event handlers keep the shared output state in sync with the UI. */
void ui_event_Button1(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);

    if(event_code == LV_EVENT_CLICKED) {
        // The main loop reads led and drives GPIO25 high for the ON button.
        led = 1;
    }
}
...
void ui_event_Button2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        // The main loop reads led and drives GPIO25 low for the OFF button.
        led = 0;
    }
}
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Button1, 58);
    lv_obj_set_height(ui_Button1, 50);
    lv_obj_set_x(ui_Button1, 152);
